...
<head>
    ...
    <title>Телекоммуникационная компания "Телеком" | Для бизнеса</title>
...
<body class="main-page">
    <header class="header">
        <div class="service-menu">
                ...
                <ul class="service-menu-list">
                    ...
                    <li class="service-menu-item">
                        <a class="service-menu-link header-link-active" href="#">Для бизнеса</a>
                    </li>
                </ul>
    ...
    <main class="main-container main-page">
        <h1 class="visually-hidden">Для бизнеса | Телекоммуникационная компания "Телеком"</h1>
        <header class="title-container title-container-business">
            <h2 class="page-title">Для бизнеса</h2>
        </header>
        ...
        <section class="rules-section">
            ...
            <div class="rules-container rules-container-business">  
                <div class="rules-container-text">
                    <p class="rules-paragraph">
                        Уважаемые потенциальные и действующие бизнес-клиенты!
                    </p>
                    <p class="rules-paragraph">
                        Рады представить Вашему вниманию блок с информацией специально для Вас.
                    </p>
                    <p class="rules-paragraph">
                        Мы предоставляем для бизнес-сегмента экслюзивные тарифы. Именно такие, какие нужны именно Вам. Поэтому для Вас нет определённого списка тарифов. Вы назначаете определённое лицо, ответственное за взаимодействие с нашей компанией. Мы заключаем договор в двухстороннем порядке, и далее начинаем сотрудничество.
                    </p>
                    <p class="rules-paragraph">
                        Мы рассчитываем на долгосрочное сотрудничество, поэтому мы взимаем плату за расторжение договора и демонтаж оборудования, но Вам нечего бояться. Наша  компания сделает всё возможное, чтобы удовлетворить даже самые прихотливые потребности наших бизнес-партнёров.
                    </p>
                    <p class="rules-paragraph">
                        Мы закупаем современное оборудование, используем передовые технологии и постоянно обслуживаем нашу сеть, поддерживая её в работоспособном, стабильном состоянии.
                    </p>
                    <p class="rules-paragraph">
                        Оплата услуг производится удобным для Вашей компании способом с желаемой периодичностью.
                    </p>
                </div>
                <div class="rules-container-text">
                    <p class="rules-paragraph">
                        Предусмотрена льготная программа тарифов для малого и среднего бизнеса, отсрочка платежей, а также скидка за долгосрочное пользование услугами нашей компании.
                    </p>
                    <p class="rules-paragraph">
                        Обратите внимание, что в нашем штате работает выездной сотрудник, который работает во внерабочее время, чтобы Ваш бизнес процветал, не завися от различных сбоев и неполадок.
Мы уже имеем опыт работы с бизнесом, государственнными и силовыми структурами в самых разных областях и нам доверяют.
                    </p>
                    <p class="rules-paragraph">
                        Для бизнес-клиентов у нас выделена отдельная линия связи, Вы можете связаться с отделом по работе с бизнесом по телефону: 
                        <a class="rules-link" href="tel:+78630000007">8 (863) 000-00-07</a>.  Также можете написать на факс для бизнеса: 
                        <a class="rules-link" href="tel:+78630000077">8 (863) 000-00-77</a>.
                    </p>
                    <p class="rules-paragraph">
                        Если у Вас возникли вопросы об использовании наших услуг или технические неполадки, вы можете просмотреть ответы на часто задаваемые вопросы или вызвать специалиста по номеру для бизнеса <a class="rules-link" href="tel:+78630000007">8 (863) 000-00-07</a>.
                    </p>
                    <p class="rules-paragraph">
                        На этой странице Вы также можете просмотреть новости компании или подробную контактную информацию.
                    </p>
                    <p class="rules-paragraph">
                        Надеемся, что наше сотрудничество будет долгосрочным и взаимным.
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="category-abonent-contacts-container">
                <figure class="office-img">
                   ...
                   <dl class="requisites-list">
                    ...
                    <p class="abonent-contacts-short-block">*Для бизнес-клиентов в штате есть выездные сотрудники, которые обслужат Вас во внерабочее время</p>
                    </div>
