...
<head>
    ...
    <title>Телекоммуникационная компания "Телеком" | Телевидение</title>
...
<body class="main-page">
    <header class="header">
        ...
        <nav class="header-nav">
            ...
            <ul class="header-menu">
                ...
                <li class="header-item">
                    <a class="header-link header-link-active" href="#">Телевидение</a>
                </li>
                <li class="header-item">
    ...
    <main class="main-container main-page">
        <h1 class="visually-hidden">Тарифы телевидения от телекоммуникационной компании "Телеком"</h1>
        <header class="title-container title-container-television">
            <h2 class="page-title">Телевидение</h2>
        </header>
        <h3 class="page-subtitle">Наши тарифы</h3>
        <section class="tariffs-screen">
            <h4 class="tariffs-screen-title">Для телевидения</h4>
            <ul class="tariffs-screen-list">
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Телеком Пропаганда</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Количество каналов</dt>
                            <dd class="tariff-description tv-icon">20 каналов</dd>
                       
                            <dt class="visually-hidden">Технология подключения</dt>
                            <dd class="tariff-description technology">цифровое тв</dd>
                        <dt class="visually-hidden">Информация</dt>
                        <dd class="tariff-description info-icon-2">доступ к федеральным каналам</dd>
                        </div>
                ...
                <li class="tariff-screen-item">
                  <div class="hit">ХИТ</div>
                    <h5 class="tariff-title">Телеком Расслабление</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Количество каналов</dt>
                            <dd class="tariff-description tv-icon">150 каналов</dd>
                       
                            <dt class="visually-hidden">Технология подключения</dt>
                            <dd class="tariff-description technology">IPTV</dd>
                        <dt class="visually-hidden">Информация</dt>
                        <dd class="tariff-description info-icon-2">требуется доступ к интернету</dd>
                        </div>
                        <div class="price-container">
                            <dt class="visually-hidden">Стоимость в рублях</dt>
                            <dd class="tariff-description price">300 в месяц</dd>
                        </div>
                    </dl>
                        <div class="tariff-button-container">
                ...
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Телеком Вся Россия</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Количество каналов</dt>
                            <dd class="tariff-description tv-icon">2000 каналов</dd>
        ...
        <section class="tariffs-screen">
            <h4 class="tariffs-screen-title">Услуги</h4>
            <ul class="tariffs-screen-list">
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Телеком ТВ Подключение</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Услуга</dt>
                            <dd class="tariff-description master-icon">Вызов мастера</dd>
                       
                            <dt class="visually-hidden">Услуга</dt>
                            <dd class="tariff-description materials-icon">Материалы</dd>
                            <dt class="visually-hidden">Информация</dt>
                            <dd class="tariff-description info-icon-1">монтаж антенны, настройка</dd>
                        </div>
                        <div class="price-container">
                            <dt class="visually-hidden">Стоимость в рублях</dt>
                            <dd class="tariff-description price">5000</dd>
                        </div>
                    </dl>  
                        <div class="tariff-button-container">
                            <button class="button tariff-button">Подключиться</button>
                ...
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Телеком ТВ Диагностика</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Услуга</dt>
                            <dd class="tariff-description master-icon">Вызов мастера</dd>
                            ...
                            <dd class="tariff-description materials-icon">Материалы</dd>
                            <dt class="visually-hidden">Информация</dt>
                            <dd class="tariff-description info-icon-3">диагностика и устранение неполадок</dd>
                        </div>
                        <div class="price-container">
                            <dt class="visually-hidden">Стоимость в рублях</dt>
                            <dd class="tariff-description price">1000</dd>
                        </div>
                    </dl>
                        <div class="tariff-button-container">
                            <button class="button tariff-button">Подключиться</button></div>
                ...
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Телеком ТВ Премиум</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Услуга</dt>
                            <dd class="tariff-description tv-icon-1"> + Зарубежные каналы</dd>
                            <dt class="visually-hidden">Информация</dt>
                            <dd class="tariff-description info-icon-4">Премиум функции и обслуживание</dd>
                        </div>
                        <div class="price-container">
                            <dt class="visually-hidden">Стоимость в рублях</dt>
                            <dd class="tariff-description price">3000 в месяц</dd>
                        </div>
                    </dl>
                        <div class="tariff-button-container">
                            <button class="button tariff-button">Подключиться</button></div>
        ...
        <section class="channels">
            <h4 class="channels-title">Вы сможете смотреть это, и не только...</h4>
            <ul class="channels-list">
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/1.png" width="150" height="150S" alt="Первый канал">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/2.png" width="150" height="150S" alt="Телевизионный канал Россия 1">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/3.png" width="150" height="150S" alt="Телевизионный канал НТВ">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/4.png" width="150" height="150S" alt="Пятый канал">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/5.png" width="150" height="150S" alt="Телевизионный канал Рен ТВ">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/6.png" width="150" height="150S" alt="Телевизионный канал Домашний">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/7.png" width="150" height="150S" alt="Телевизионный канал СТС">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/8.png" width="150" height="150S" alt="Телевизионный канал ТНТ">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/9.png" width="150" height="150S" alt="Телевизионный канал ТВ-3">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/10.png" width="150" height="150S" alt="Телевизионный канал Дважды Два">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/11.png" width="150" height="150S" alt="Телевизионный канал Муз ТВ">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/12.png" width="150" height="150S" alt="Телевизионный канал Россия 24">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/13.png" width="150" height="150S" alt="Телевизионный канал Россия Культура">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/14.png" width="150" height="150S" alt="Телевизионный канал Чё">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/15.png" width="150" height="150S" alt="Телевизионный канал Авто Плюс">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/16.png" width="150" height="150S" alt="Телевизионный канал Русская ночь">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/17.png" width="150" height="150S" alt="Телевизионный канал Нэшионал Джеографик">
                </li>
                <li class="channels-item">
                    <img src="src/img/icons/television-channels-logos/18.png" width="150" height="150S" alt="Телевизионный канал Никелодеон">
                </li>
            </ul>
        ...
        <section class="reviews">
            ...
            <div class="review-container">
                ...
                <div class="review-text-container">
                    <p class="review-text">
                        <span class="quote"><<</span>  Люблю “позалипать”, как говорит нынче молодёжь на выступления команды КВН от ДГТУ на Первом канале.
        ...
        <li class="reviews-item review-item-2">
            <div class="review-container">
                ...
                <div class="review-text-container">
                    <p class="review-text">
                        <span class="quote"><<</span>  Смотрю донские новости и восхищаюсь, что там говорят только правду, и ничего лишнего. В Ростове, как всегда, проблем нет.
        ...
        <li class="reviews-item review-item-3">
            <div class="review-container">
                ...
                <div class="review-text-container">
                    <p class="review-text">
                        <span class="quote"><<</span>  Вечерком люблю присесть на диванчик и поглазеть на Кубань ТВ, ведь если и есть на свете рай - это Краснодарский краай.
        ...
        <li class="reviews-item review-item-4">
            <div class="review-container">
                ...
                <div class="review-text-container">
                    <p class="review-text">
                        <span class="quote"><<</span> Я люблю смотреть телевизор. Очень нравится передача Ольги Скабеевой. “Телеком” предоставил мне эту возможность.
    ...
    <footer class="footer">
        ...
        <p class="footer-text">вс: выходной</p>
            ...
            <ul class="footer-list">
                ...
                <li class="footer-item">
                    <a class="footer-link" href="#">Телевидение</a>
                </li>
                <li class="footer-item">
