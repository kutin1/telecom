...
<head>
    ...
    <title>Телекоммуникационная компания "Телеком" | Для частных лиц</title>
...
<body class="main-page">
        ...
        <div class="service-menu">
                ...
                <ul class="service-menu-list">
                    <li class="service-menu-item">
                        <a class="service-menu-link header-link-active" href="#">Для частных лиц</a>
                    </li>
                    <li class="service-menu-item">
    ...
    <main class="main-container main-page">
        <h1 class="visually-hidden">Для частных лиц | Телекоммуникационная компания "Телеком"</h1>
        <header class="title-container title-container-person">
            <h2 class="page-title">Для частных лиц</h2>
        </header>
        <h3 class="category-abonent-title">Мы рады Вас приветствовать!</h3>
        <section class="category-abonent-about">
            <div class="category-abonent-about-text">
                <p class="category-abonent-about-text-p">Эта страница предназначена для уведомления Вас о порядке предоставления услуг, новостях компании, юридической, а также контактной информации для связи с представителями компании. Мы будем рады иметь с Вами возможность работать, независимо от того, клиент ли Вы нашей компании или только хотите им стать.</p>
            </div>
            <div class="category-abonent-about-image">
            </div>
        </section>
        <section class="about">
            ...
            <p class="about-description">Мы являемся молодой, но стремительно развивающейся компанией по предоставлению телекоммуникационных услуг на юге России. Начиная свою деятельность в 2024 году мы выбрали своими приоритетами честность при работе с клиентами и использование качественных материалов в своей деятельности. Мы всегда стремимся быть лучше, идти в ногу со временем и быть лучшими в своей области.</p>
            </div>
        </div>
        </section>
        <section class="rules-section">
            <h3 class="rules-title">Порядок предоставления услуг</h3>
            <div class="rules-container">  
                <div class="rules-container-text">
                    <p class="rules-paragraph">
                        Если Вы хотите стать нашим клиентом, но так и не разобрались как тут всё у нас устроено, но каким-то образом попали на эту страницу, сейчас всё Вам расскажем.
                    </p>
                    <p class="rules-paragraph">
                        Для начала Вы сразу можете зайти на <a class="rules-link" href="index.php">главную страницу</a> и там заполнить простейшую форму обратной связи, и наш оператор в кратчайшие сроки позвонит Вам. Форма требует минимальные данные, такие как Ваше имя, чтобы знать как к Вам обращаться, Ваш номер телефона, чтобы знать, как связаться с Вами и Ваш адрес подключения, чтобы мы заранее всё проверили и не заставляли Вас ждать проверки во время звонка. Желательно также укажите, какие виды услуг Вы собираетесь подключать. Это может быть интернет, телевидение, мобильная связь, а может и всё сразу. Не волнуйтесь, данные формы защищены и они никуда, кроме как к нам не попадут.
                    </p>
                    <p class="rules-paragraph">
                        Также Вы можете перейти по ссылкам  <a class="rules-link" href="internet.php">Интернет</a>, <a class="rules-link" href="television.php">Телевидение</a>, <a class="rules-link" href="mobile.php">Мобильная связь</a> в верхнем меню сайта и выбрать подходящий Вам тариф для конкретной категории услуг. Также там Вы найдёте услуги, позволяющие “прокачать” Ваши подключённые тарифы. Вы нажимаете кнопку “Подключить” на карточке тарифа, и открывается форма обратной связи, о которой было сказано выше. 

                    </p>
                </div>
                <div class="rules-container-text">
                    <p class="rules-paragraph">
                        В любом случае Вам придётся взаимодействовать с нашим менеджером, который сможет проверить возможность подключения или отсутствие таковой (к сожалению, такое бывает) по Вашему адресу соответствующему выбранному тарифу или услуги.
                    </p>
                    <p class="rules-paragraph">
                        Далее, по  <a class="rules-link" href="tel:+78630000001">телефону</a>, мы согласуем с Вами визит наших сотрудников к Вам в гости для проведения соответствующих мероприятий по подключению. Также с Вами заключается договор и Вам присваивается номер Вашего личного лицевого счёта и пароль, по которым Вы сможете заходить в Ваш личный кабинет и просматривать Ваш баланс, подключённые тарифы и услуги, а также все данные, которые мы храним о Вас.
                    </p>
                    <p class="rules-paragraph">
                        Если у Вас возникли вопросы об использовании наших услуг или технические неполадки, вы можете просмотреть ответы на часто задаваемые вопросы или вызвать специалиста по номеру <a class="rules-link" href="tel:+78630000001">8 (863) 000-00-01</a>.
                    </p>
                    <p class="rules-paragraph">
                        На этой странице Вы также можете просмотреть новости компании или подробную контактную информацию.
                    </p>
                    <p class="rules-paragraph">
                        Надеемся, что наш гайд поможет лучше понять, как тут у нас всё устроено.
                    </p>
                </div>
            </div>
        </section>
        <section class="news">
            <h3 class="news-title">Наши новости</h3>
            <div class="news-container">
                <ul class="news-list">
                    <li class="news-item">
                        <div class="news-icon newspaper-icon"></div>
                        <div class="news-content">
                        <h4 class="news-item-title">“Телеком” отмечает полгода с момента основания</h4>
                        <p class="news-item-text">С недавнего основания компании “Телеком” не прошло и года, как она плотно обосновалась на рынке и уже уверенно обходит конкурентов на рынке телекомуникационных услуг.</p>
                        <time class="news-date" datetime="2024-05-04T00:00:00">4 мая 2024 г. в 0:00 мск</time>
                        </div>
                    </li>
                    <li class="news-item">
                        <div class="news-icon announcement-icon"></div>
                        <div class="news-content">
                        <h4 class="news-item-title">Ожидается повышение цен на тарифы</h4>
                        <p class="news-item-text">В связи с геополитической обстановкой в стране с сожалением сообщаем Вам о повышении цен на все тарифы на 25% с 01.01.2025 г.</p>
                        <time class="news-date" datetime="2024-05-01T00:00:00">1 мая 2024 г. в 0:00 мск</time>
                        </div>
                    </li>
                    <li class="news-item">
                        <div class="news-icon announcement-icon"></div>
                        <div class="news-content">
                        <h4 class="news-item-title">Мы входим в топ 10 телекоммуникационных компаний</h4>
                        <p class="news-item-text">Новый рейтинг “Ведомостей” включил компанию “Телеком” в топ 10 компаний на рынке телекоммуникационных услуг на юге России! Рады стараться для Вас!</p>
                        <time class="news-date" datetime="2024-02-24T00:00:00"> 24 февраля 2024 г. в 0:00 мск</time>
                        </div>
                    </li>
                </ul>
            </div>
        </section>
        <section class="category-abonent-contacts">
            <h3 class="category-abonent-contacts-title">Наши контакты</h3>
            <div class="category-abonent-contacts-container">
                <figure class="office-img">
                    <p><img class="office-img-picture" src="src/img/content/dstu.jpg" width="967" height="500" alt="Один из офисов Телекома"></p>
                    <figcaption class="office-img-figcaption">Один из наших офисов</figcaption>
                   </figure>
                   <dl class="requisites-list">
                    <dt class="requisites-term">Полное наименование</dt>
                    <dd class="requisites-description">Общество с ограниченной ответственностью «Телеком»</dd>
                    <dt class="requisites-term">Сокращенное наименование предприятия</dt>
                    <dd class="requisites-description">ООО «Телеком»</dd>
                    <dt class="requisites-term">ОГРН</dt>
                    <dd class="requisites-description">11111111111111 от 01.01.2024</dd>
                    <dt class="requisites-term">Юридический адрес</dt>
                    <dd class="requisites-description">344000, г. Ростов-на-Дону, пл. Гагарина, д. 1, офис 101</dd>
                    <dt class="requisites-term">Адрес для корреспонденции</dt>
                    <dd class="requisites-description">344003, г. Ростов-на-Дону, пл. Гагарина, д. 1, стр 14, офис 1213</dd>
                    <dt class="requisites-term">ИНН</dt>
                    <dd class="requisites-description">1111111111</dd>
                    <dt class="requisites-term">КПП</dt>
                    <dd class="requisites-description">111111111</dd>
                    <dt class="requisites-term">Расчетный счёт</dt>
                    <dd class="requisites-description">11111111111111111111</dd>
                    <dt class="requisites-term">Наименование банка</dt>
                    <dd class="requisites-description">Центральный Банк России</dd>
                    <dt class="requisites-term">Корреспондентский счет</dt>
                    <dd class="requisites-description">11111111111111111111</dd>
                    <dt class="requisites-term">БИК</dt>
                    <dd class="requisites-description">111111111</dd>
                    <dt class="requisites-term">Код по ОКПО</dt>
                    <dd class="requisites-description">11111111</dd>
                    <dt class="requisites-term">ОКАТО</dt>
                    <dd class="requisites-description">11111111111</dd>
                    <dt class="requisites-term">ОКВЭД</dt>
                    <dd class="requisites-description">61.90</dd>
                    <dt class="requisites-term">Телефоны</dt>
                    <dd class="requisites-description">(863) 000-00-01</dd>
                    <dt class="requisites-term">Факс</dt>
                    <dd class="requisites-description">(863) 000-00-00</dd>
                    <dt class="requisites-term">Руководитель</dt>
                    <dd class="requisites-description">Генеральный директор  ООО «Телеком» Кутин Владислав Константинович</dd>
                    <dt class="requisites-term">Главный бухгалтер</dt>
                    <dd class="requisites-description">Конопля Марья Ивановна</dd>
                    </dl>
                    <h4 class="category-abonent-contacts-subtitle">Если Вы испугались реквизитов компании,  продублируем основные контакты:</h4>
                    <iframe class="map" id="map_249669650" frameborder="0" width="955px" height="434px" sandbox="allow-modals allow-forms allow-scripts allow-same-origin allow-popups allow-top-navigation-by-user-activation"></iframe><script type="text/javascript">(function(e,t){var r=document.getElementById(e);r.contentWindow.document.open(),r.contentWindow.document.write(atob(t)),r.contentWindow.document.close()})("map_249669650", "")</script>
                    <div class="map-figcaption-container">
                    <p class="map-figcaption">Мы на карте</p>
                    </div>
                    <div class="abonent-contacts-short-block-container">
                    <p class="abonent-contacts-short-block">Наше название: ООО “Телеком”</p>
                    <p class="abonent-contacts-short-block">Наш телефон: <a class="black-link" href="tel:+78630000001">8 (863) 000-00-01</a></p>
                    <p class="abonent-contacts-short-block">Наш адрес: РФ, г. Ростов-на-Дону, пл. Гагарина, д. 1, стр. 14, офис 1213</p>
                    </div>
                    <h4 class="category-abonent-schedule-subtitle">Наш режим работы:</h4>
                    <dl class="schedule-list">
                        <dt class="schedule-term">понедельник-суббота</dt>
                        <dd class="schedule-description">с 10:00 по 18:00</dd>
                        <dt class="schedule-term">воскресенье</dt>
                        <dd class="schedule-description">выходной</dd>
                    </dl>
                </div>
        </section>
    </main>
