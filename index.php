...
<head>
    ...
    <title>Телекоммуникационная компания "Телеком" | Главная страница</title>
...
<body class="main-page">
            ...
            <ul class="service-menu-list icons-list">
                <li class="service-menu-item">
                    <a class="service-menu-link service-menu-location" href="#" id="cityModalLink">
                        ...
                        <span class="location-text">Ростов-на-Дону</span>
                    </a>
                </li>
                <li class="service-menu-item">
                    <a class="service-menu-link service-menu-account" href="#" id="loginModalLink">
                        ...
                        <span class="location-text">Личный кабинет</span>
                    </a>
                </li>
            </ul>
            <!-- Модальное окно -->
        ...
        <div id="connectModal" class="modal-connect">
            <div class="modal-content-connect">
                ...
                <div class="modal-feedback-form-container">
                    <form class="modal-feedback-form" action="config/submit_form_connect.php" method="POST" id="modal-connect-form">
    ...
    <main class="main-container main-page">
        <h1 class="visually-hidden">Телекоммуникационная компания "Телеком"</h1>
        <section class="promo-slider">
            <h2 class="visually-hidden">Хиты подключений</h2>
            <!-- разработка слайдера -->
            <div class="slider">
                <div class="slider-item item1 active">
                    <div class="slide-content">
                        <p class="promo-slider-text">Успей подключиться к<br> домашнему интернету по<br> технологии GPON со<br> скоростью до 1 Гбит/сек!</p>
                        <p class="legal-info">НЕ ЯВЛЯЕТСЯ ПУБЛИЧНОЙ ОФЕРТОЙ
                            Вся представленная на сайте информация, касающаяся технических характеристик, наличия на складе, стоимости товаров, носит информационный характер и ни при каких условиях не является публичной офертой, определяемой положениями Статьи 437(2) Гражданского кодекса РФ.
                            Предложение действует при подключении с 01.06.2024 по 31.12.2024.
                            Стоимость подключения интернета в момент акции составит 9999 рублей.
                            Подробности уточняйте у консультантов.</p>
                    </div>
                </div>
                <div class="slider-item item2">
                    <div class="slide-content">
                        <p class="promo-slider-text">Получи возможность просматривать 1512 каналов на своём телевизоре через интернет по технологии IPTV!</p>
                        <p class="legal-info">НЕ ЯВЛЯЕТСЯ ПУБЛИЧНОЙ ОФЕРТОЙ
                            Вся представленная на сайте информация, касающаяся технических характеристик, наличия на складе, стоимости товаров, носит информационный характер и ни при каких условиях не является публичной офертой, определяемой положениями Статьи 437(2) Гражданского кодекса РФ.
                            Предложение действует при подключении с 01.06.2024 по 31.12.2024.
                            Стоимость подключения интернета в момент акции составит 9999 рублей.
                ...
                <div class="slider-item item3">
                    <div class="slide-content">
                        <p class="promo-slider-text">Получи безлимитный интернет, 5000 минут и СМС на тарифе “Телеком-Максимум”. Закажи симку прямо сейчас!</p>
                        <p class="legal-info">НЕ ЯВЛЯЕТСЯ ПУБЛИЧНОЙ ОФЕРТОЙ
                            Вся представленная на сайте информация, касающаяся технических характеристик, наличия на складе, стоимости товаров, носит информационный характер и ни при каких условиях не является публичной офертой, определяемой положениями Статьи 437(2) Гражданского кодекса РФ.
                            Предложение действует при подключении с 01.06.2024 по 31.12.2024.
                            Стоимость подключения интернета в момент акции составит 9999 рублей.
                ...
                <div class="slider-item item4">
                    <div class="slide-content">
                        <p class="promo-slider-text">Нам доверяют. Мы входим в топ 10 телекоммуникационных компаний. Новый рейтинг “Ведомостей”</p>
                        <p class="legal-info">НЕ ЯВЛЯЕТСЯ ПУБЛИЧНОЙ ОФЕРТОЙ
                            Вся представленная на сайте информация, касающаяся технических характеристик, наличия на складе, стоимости товаров, носит информационный характер и ни при каких условиях не является публичной офертой, определяемой положениями Статьи 437(2) Гражданского кодекса РФ.
                            Предложение действует при подключении с 01.06.2024 по 31.12.2024.
                            Стоимость подключения интернета в момент акции составит 9999 рублей.
            ...
            <div class="features-menu">
                <ul class="features-menu-list">
                    <li class="features-menu-item">
                        <a class="features-menu-link" data-target="quality">Качество</a>
                    </li>
                    <li class="features-menu-item">
                        <a class="features-menu-link" data-target="reliability">Надёжность</a>
                    </li>
                    <li class="features-menu-item">
                        <a class="features-menu-link" data-target="speed">Скорость</a>
                    </li>
                    <li class="features-menu-item">
                        <a class="features-menu-link" data-target="security">Безопасность</a>
                    </li>
                </ul>
            </div>
                <div class="features-screens">
                    <div id="quality" class="features-screen active">
                        <div class="feature-screen-container">
                            <div class="feature-svg">
                                <img class="feature-svg-img" src="src/img/icons/feature1.svg">
                            </div>
                            <div class="feature-text">
                                <p>В наших проектах мы используем самые передовые технологии от ведущих мировых производителей. Мы постоянно проводим мониторинг качества оказания услуг, чтобы быть лучше для Вас!</p>
                            </div>
                        </div>
                    </div>
                    <div id="reliability" class="features-screen">
                        <div class="feature-screen-container">
                            <div class="feature-svg">
                                <img class="feature-svg-img" src="src/img/icons/feature2.svg">
                            </div>
                            <div class="feature-text">
                                <p>Мы работаем и оказываем услуги, постоянно контролируя работоспособность нашего оборудования, а также качество оказания наших услуг. Мы стараемся не допускать неисправностей, но если они всё-таки возникнут, наши специалисты постараются всё починить в кратчайшие сроки. Если проблема возникла на нашей стороне, вы ничего не заплатите.</p>
                            </div>
                        </div>
                    </div>
                    <div id="speed" class="features-screen">
                        <div class="feature-screen-container">
                            <div class="feature-svg">
                                <img class="feature-svg-img" src="src/img/icons/feature3.svg">
                            </div>
                            <div class="feature-text">
                                <p>Наш интернет, телевидение и мобильная связь стремятся быть самыми быстрыми на рынке телекоммуникационных услуг. Мы неоднократно занимали лидирующие позиции по скорости сервисов в РФ.</p>
                            </div>
                        </div>
                    </div>
                    <div id="security" class="features-screen">
                        <div class="feature-screen-container">
                            <div class="feature-svg">
                                <img class="feature-svg-img" src="src/img/icons/feature4.svg">
                            </div>
                            <div class="feature-text">
                                <p>Мы используем собственные технологии шифрования данных, обеспечивая для Вас и Ваших близких спокойствие за безопасность и конфиденциальность передаваемых данных. Также наша сеть защищена от хакерских атак и постоянно сканируется на вирусную активность. Будьте уверены, что мы стоим на страже Вашей приватности!</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="feedback">
            <h2 class="feedback-title">Проверьте возможность подключения</h2>
            <div class="feedback-form-container">
                <div class="feedback-form-container-data">
                    <form  class="feedback-form" action="config/submit_form.php" method="POST">
                    <p class="form-description">Оставьте заявку, и наш оператор свяжется с Вами в течение 30 минут*</p>
                    <div class="input-inner">
                    <div class="custom-field">
                    
                    <label class="form-field-label" for="name">Введите Ваше имя*</label>
                    <input class="form-field-input" type="text" id="name" name="name" required>

                    </div>

                    <div class="custom-field">
                    
                    <label class="form-field-label" for="phone">Введите Ваш номер телефона*</label>
                    <input class="form-field-input" type="tel" id="phone" name="phone" required>
                    
                    </div>

                    <div class="custom-field">

                    <label class="form-field-label" for="address">Введите Ваш адрес подключения*</label>
                    <input class="form-field-input" type="text" id="address" name="address" required>

                    </div>
                    </div>

                    <h3 class="form-subtitle">Что Вы хотите подключить?</h3>
<ul class="form-services-list">
    <li class="form-services-item">
        <label class="form-checkbox-label" for="home_internet_checkbox">
            <input class="form-checkbox" type="checkbox" id="home_internet_checkbox" name="services[]" value="Домашний интернет">
            <span class="custom-checkbox"></span>
            Домашний интернет
        </label>
    </li>
    <li class="form-services-item">
        <label class="form-checkbox-label" for="television_checkbox">
            <input class="form-checkbox" type="checkbox" id="television_checkbox" name="services[]" value="Телевидение">
            <span class="custom-checkbox"></span>
            Телевидение
        </label>
    </li>
    <li class="form-services-item">
        <label class="form-checkbox-label" for="mobile_checkbox">
            <input class="form-checkbox" type="checkbox" id="mobile_checkbox" name="services[]" value="Мобильная связь">
            <span class="custom-checkbox"></span>
            Мобильная связь
        </label>
    </li>
...
<p class="form-security-info">Все отправляемые данные защищены сквозным шифрованием. 
    *Время ответа оператора может отличаться, указаны  средние данные.</p>

                    </form>
                </div>
                <div class="feedback-form-container-decoration">
                    <img src="src/img/content/feedback-form-decoration.jpg" width="546" height="784">
                </div>
            </div>
        </section>
        <section class="about">
