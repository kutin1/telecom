...
<head>
    ...
    <title>Телекоммуникационная компания "Телеком" | Помощь</title>
...
<body class="main-page">
    ...
    <main class="main-container main-page">
        <h1 class="visually-hidden">Помощь | Телекоммуникационная компания "Телеком"</h1>
        <header class="title-container title-container-help">
            <h2 class="page-title">Помощь</h2>
        </header>
        <h3 class="faq-title">Ответы на часто задаваемые вопросы</h3>
        <section class="faq-container">
            <div class="faq-container-wallpaper">
                <ul class="faq-list">
                    <li class="faq-item">
                        <div class="question">
                            <span>Не работает интернет, что делать?</span>
                            <svg class="faq-arrow" xmlns="http://www.w3.org/2000/svg" width="74" height="55" viewBox="0 0 74 55" fill="none">
                                <path d="M36.9913 54.9999C37.5655 55.0013 38.1342 54.8522 38.6651 54.561C39.1959 54.2699 39.6784 53.8425 40.0849 53.3033L72.7734 9.84702C73.5694 8.75116 74.0098 7.28343 73.9998 5.75995C73.9899 4.23647 73.5303 2.77914 72.7202 1.70184C71.91 0.624538 70.8141 0.0134583 69.6684 0.00021965C68.5227 -0.013019 67.419 0.57264 66.5949 1.63106L37.0044 40.9735L7.40511 1.63106C6.58101 0.57264 5.47725 -0.013019 4.33157 0.00021965C3.18589 0.0134583 2.08996 0.624538 1.27981 1.70184C0.469661 2.77914 0.0101208 4.23647 0.00016518 5.75995C-0.00979046 7.28343 0.430634 8.75116 1.22658 9.84702L33.8845 53.3033C34.2926 53.8446 34.7772 54.2732 35.3104 54.5644C35.8436 54.8556 36.4149 55.0036 36.9913 54.9999Z" fill="#4146CE"/>
                            </svg>
                        </div>
                        <div class="answer">Попробуйте перезагрузить роутер, вытащив вилку из розетки на 10 минут и воткнуть вновь. Также попробуйте изменить настройки интернета на вашем устройстве.</div>
                    </li>
                    <li class="faq-item">
                        <div class="question">
                            <span>Не работает телевидение, что делать?</span>
                            <svg class="faq-arrow" xmlns="http://www.w3.org/2000/svg" width="74" height="55" viewBox="0 0 74 55" fill="none">
                                <path d="M36.9913 54.9999C37.5655 55.0013 38.1342 54.8522 38.6651 54.561C39.1959 54.2699 39.6784 53.8425 40.0849 53.3033L72.7734 9.84702C73.5694 8.75116 74.0098 7.28343 73.9998 5.75995C73.9899 4.23647 73.5303 2.77914 72.7202 1.70184C71.91 0.624538 70.8141 0.0134583 69.6684 0.00021965C68.5227 -0.013019 67.419 0.57264 66.5949 1.63106L37.0044 40.9735L7.40511 1.63106C6.58101 0.57264 5.47725 -0.013019 4.33157 0.00021965C3.18589 0.0134583 2.08996 0.624538 1.27981 1.70184C0.469661 2.77914 0.0101208 4.23647 0.00016518 5.75995C-0.00979046 7.28343 0.430634 8.75116 1.22658 9.84702L33.8845 53.3033C34.2926 53.8446 34.7772 54.2732 35.3104 54.5644C35.8436 54.8556 36.4149 55.0036 36.9913 54.9999Z" fill="#4146CE"/>
                            </svg>
                        </div>
                        <div class="answer">Попробуйте проверить состояние телевизинного кабеля и состояние антенны. Если телевидение подключено через интернет, проверьте состояние интернет-кабеля.</div>
                    </li>
                    <li class="faq-item">
                        <div class="question">
                            <span>Не работает мобильная связь, что делать?</span>
                            <svg class="faq-arrow" xmlns="http://www.w3.org/2000/svg" width="74" height="55" viewBox="0 0 74 55" fill="none">
                                <path d="M36.9913 54.9999C37.5655 55.0013 38.1342 54.8522 38.6651 54.561C39.1959 54.2699 39.6784 53.8425 40.0849 53.3033L72.7734 9.84702C73.5694 8.75116 74.0098 7.28343 73.9998 5.75995C73.9899 4.23647 73.5303 2.77914 72.7202 1.70184C71.91 0.624538 70.8141 0.0134583 69.6684 0.00021965C68.5227 -0.013019 67.419 0.57264 66.5949 1.63106L37.0044 40.9735L7.40511 1.63106C6.58101 0.57264 5.47725 -0.013019 4.33157 0.00021965C3.18589 0.0134583 2.08996 0.624538 1.27981 1.70184C0.469661 2.77914 0.0101208 4.23647 0.00016518 5.75995C-0.00979046 7.28343 0.430634 8.75116 1.22658 9.84702L33.8845 53.3033C34.2926 53.8446 34.7772 54.2732 35.3104 54.5644C35.8436 54.8556 36.4149 55.0036 36.9913 54.9999Z" fill="#4146CE"/>
                            </svg>
                        </div>
                        <div class="answer">Проверьте, включена ли функция передачи мобильных данных, а также используются ли анонимайзеры или иные сервисы для получения доступа к запрещённой информации. Попробуйте отключить их.</div>
                    </li>
                    <li class="faq-item">
                        <div class="question">
                            <span>Как произвести оплату услуг?</span>
                            <svg class="faq-arrow" xmlns="http://www.w3.org/2000/svg" width="74" height="55" viewBox="0 0 74 55" fill="none">
                                <path d="M36.9913 54.9999C37.5655 55.0013 38.1342 54.8522 38.6651 54.561C39.1959 54.2699 39.6784 53.8425 40.0849 53.3033L72.7734 9.84702C73.5694 8.75116 74.0098 7.28343 73.9998 5.75995C73.9899 4.23647 73.5303 2.77914 72.7202 1.70184C71.91 0.624538 70.8141 0.0134583 69.6684 0.00021965C68.5227 -0.013019 67.419 0.57264 66.5949 1.63106L37.0044 40.9735L7.40511 1.63106C6.58101 0.57264 5.47725 -0.013019 4.33157 0.00021965C3.18589 0.0134583 2.08996 0.624538 1.27981 1.70184C0.469661 2.77914 0.0101208 4.23647 0.00016518 5.75995C-0.00979046 7.28343 0.430634 8.75116 1.22658 9.84702L33.8845 53.3033C34.2926 53.8446 34.7772 54.2732 35.3104 54.5644C35.8436 54.8556 36.4149 55.0036 36.9913 54.9999Z" fill="#4146CE"/>
                            </svg>
                        </div>
                        <div class="answer">Вы можете пополнить баланс своего лицевого счёта через личный кабинет.</div>
                    </li>
                    <li class="faq-item">
                        <div class="question">
                            <span>Как зайти в свой личный кабинет?</span>
                            <svg class="faq-arrow" xmlns="http://www.w3.org/2000/svg" width="74" height="55" viewBox="0 0 74 55" fill="none">
                                <path d="M36.9913 54.9999C37.5655 55.0013 38.1342 54.8522 38.6651 54.561C39.1959 54.2699 39.6784 53.8425 40.0849 53.3033L72.7734 9.84702C73.5694 8.75116 74.0098 7.28343 73.9998 5.75995C73.9899 4.23647 73.5303 2.77914 72.7202 1.70184C71.91 0.624538 70.8141 0.0134583 69.6684 0.00021965C68.5227 -0.013019 67.419 0.57264 66.5949 1.63106L37.0044 40.9735L7.40511 1.63106C6.58101 0.57264 5.47725 -0.013019 4.33157 0.00021965C3.18589 0.0134583 2.08996 0.624538 1.27981 1.70184C0.469661 2.77914 0.0101208 4.23647 0.00016518 5.75995C-0.00979046 7.28343 0.430634 8.75116 1.22658 9.84702L33.8845 53.3033C34.2926 53.8446 34.7772 54.2732 35.3104 54.5644C35.8436 54.8556 36.4149 55.0036 36.9913 54.9999Z" fill="#4146CE"/>
                            </svg>
                        </div>
                        <div class="answer">Вы можете произвести авторизацию в свой личный кабинет через логин и пароль, указанные в договоре с компанией.</div>
                    </li>
                    <li class="faq-item">
                        <div class="question">
                            <span>Где мне просмотреть доступные тарифы?</span>
                            <svg class="faq-arrow" xmlns="http://www.w3.org/2000/svg" width="74" height="55" viewBox="0 0 74 55" fill="none">
                                <path d="M36.9913 54.9999C37.5655 55.0013 38.1342 54.8522 38.6651 54.561C39.1959 54.2699 39.6784 53.8425 40.0849 53.3033L72.7734 9.84702C73.5694 8.75116 74.0098 7.28343 73.9998 5.75995C73.9899 4.23647 73.5303 2.77914 72.7202 1.70184C71.91 0.624538 70.8141 0.0134583 69.6684 0.00021965C68.5227 -0.013019 67.419 0.57264 66.5949 1.63106L37.0044 40.9735L7.40511 1.63106C6.58101 0.57264 5.47725 -0.013019 4.33157 0.00021965C3.18589 0.0134583 2.08996 0.624538 1.27981 1.70184C0.469661 2.77914 0.0101208 4.23647 0.00016518 5.75995C-0.00979046 7.28343 0.430634 8.75116 1.22658 9.84702L33.8845 53.3033C34.2926 53.8446 34.7772 54.2732 35.3104 54.5644C35.8436 54.8556 36.4149 55.0036 36.9913 54.9999Z" fill="#4146CE"/>
                            </svg>
                        </div>
                        <div class="answer">Вы можете просмотреть доступные тарифы на страницах Интернет, Телевидение и Мобильная связь соответственно. Обращаем Ваше внимаем, возможность подключения уточняется отдельно.</div>
                    </li>
                    <li class="faq-item">
                        <div class="question">
                            <span>Наше домашнее животное перекусило телекоммуникационный кабель. Что делать?</span>
                            <svg class="faq-arrow" xmlns="http://www.w3.org/2000/svg" width="74" height="55" viewBox="0 0 74 55" fill="none">
                                <path d="M36.9913 54.9999C37.5655 55.0013 38.1342 54.8522 38.6651 54.561C39.1959 54.2699 39.6784 53.8425 40.0849 53.3033L72.7734 9.84702C73.5694 8.75116 74.0098 7.28343 73.9998 5.75995C73.9899 4.23647 73.5303 2.77914 72.7202 1.70184C71.91 0.624538 70.8141 0.0134583 69.6684 0.00021965C68.5227 -0.013019 67.419 0.57264 66.5949 1.63106L37.0044 40.9735L7.40511 1.63106C6.58101 0.57264 5.47725 -0.013019 4.33157 0.00021965C3.18589 0.0134583 2.08996 0.624538 1.27981 1.70184C0.469661 2.77914 0.0101208 4.23647 0.00016518 5.75995C-0.00979046 7.28343 0.430634 8.75116 1.22658 9.84702L33.8845 53.3033C34.2926 53.8446 34.7772 54.2732 35.3104 54.5644C35.8436 54.8556 36.4149 55.0036 36.9913 54.9999Z" fill="#4146CE"/>
                            </svg>
                        </div>
                        <div class="answer">Вы можете оставить заявку на ремонтные работы, обратившись по телефону горячей линии. Мы Вам обязательно поможем. 😊</div>
                    </li>
                    <li class="faq-item">
                        <div class="question">
                            <span>Как сменить тариф?</span>
                            <svg class="faq-arrow" xmlns="http://www.w3.org/2000/svg" width="74" height="55" viewBox="0 0 74 55" fill="none">
                                <path d="M36.9913 54.9999C37.5655 55.0013 38.1342 54.8522 38.6651 54.561C39.1959 54.2699 39.6784 53.8425 40.0849 53.3033L72.7734 9.84702C73.5694 8.75116 74.0098 7.28343 73.9998 5.75995C73.9899 4.23647 73.5303 2.77914 72.7202 1.70184C71.91 0.624538 70.8141 0.0134583 69.6684 0.00021965C68.5227 -0.013019 67.419 0.57264 66.5949 1.63106L37.0044 40.9735L7.40511 1.63106C6.58101 0.57264 5.47725 -0.013019 4.33157 0.00021965C3.18589 0.0134583 2.08996 0.624538 1.27981 1.70184C0.469661 2.77914 0.0101208 4.23647 0.00016518 5.75995C-0.00979046 7.28343 0.430634 8.75116 1.22658 9.84702L33.8845 53.3033C34.2926 53.8446 34.7772 54.2732 35.3104 54.5644C35.8436 54.8556 36.4149 55.0036 36.9913 54.9999Z" fill="#4146CE"/>
                            </svg>
                        </div>
                        <div class="answer">Вы можете выбрать тариф на соответветствующих старницах нашего сайта. Обратите внимание, дотсупность Вам того или иного тарифа или услуги уточняется отдельно.</div>
                    </li>
                </ul>
            </div>
        </section>
        <h3 class="faq-title">Контакты поддержки</h3>
        <section class="faq-contacts">
            <dl class="faq-contacts-list">
                <dt class="faq-contacts-term">Телефон горячей линии компании</dt>
                <dd class="faq-contacts-description">8 (863) 000-00-01</dd>
                <dt class="faq-contacts-term">Телефон горячей линии  агентов помощи клиентам</dt>
                <dd class="faq-contacts-description">8 (863) 000-04-04</dd>
                <dt class="faq-contacts-term">Электронная почта компании:</dt>
                <dd class="faq-contacts-description">mail@telecom.ru</dd>
                <dt class="faq-contacts-term">Электронная почта поддержки:</dt>
                <dd class="faq-contacts-description">help@telecom.ru</dd>
                <dt class="faq-contacts-term">Факс компании:</dt>
                <dd class="faq-contacts-description">8 (863) 000-00-00</dd>
                <dt class="faq-contacts-term">Телефон помощи для бизнеса:</dt>
                <dd class="faq-contacts-description">8 (863) 000-00-07</dd>
                <dt class="faq-contacts-term">Факс помощи для бизнеса:</dt>
                <dd class="faq-contacts-description">8 (863) 000-00-77</dd>
            </dl>
        </section>
    </main>
    <footer class="footer">
