...
<head>
    ...
    <title>Телекоммуникационная компания "Телеком" | Домашний интернет</title>
...
<body class="main-page">
        ...
        <div class="service-menu">
            ...
            <div id="loginModal" class="modal-login">
                <div class="modal-content-login">
                    ...
                    <form  class="login-form" action="config/auth.php" method="POST" id="loginForm">
        ...
        <nav class="header-nav">
            ...
            <ul class="header-menu">
                <li class="header-item">
                    <a class="header-link header-link-active" href="#">Интернет</a>
                </li>
                <li class="header-item">
    ...
    <main class="main-container main-page">
        <h1 class="visually-hidden">Тарифы интернет от телекоммуникационной компании "Телеком"</h1>
        <header class="title-container title-container-internet">
            <h2 class="page-title">Интернет</h2>
        </header>
        <h3 class="page-subtitle">Наши тарифы</h3>
        <section class="tariffs-screen">
            <h4 class="tariffs-screen-title">Для многоквартирных домов</h4>
            <ul class="tariffs-screen-list">
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Телеком Старт</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Скорость подключения</dt>
                            <dd class="tariff-description speed">30 Мбит/сек</dd>
                       
                            <dt class="visually-hidden">Технология подключения</dt>
                            <dd class="tariff-description technology">FTTB (ETTH)</dd>
                        <dt class="visually-hidden">Объём данных</dt>
                        <dd class="tariff-description volume-unlimited">безлимитный трафик</dd>
                        </div>
                        <div class="price-container">
                            <dt class="visually-hidden">Стоимость в рублях</dt>
                            <dd class="tariff-description price">500 в месяц</dd>
                        </div>
                    </dl>  
                ...
                <li class="tariff-screen-item">
                  <div class="hit">ХИТ</div>
                    <h5 class="tariff-title">Телеком Комфорт</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Скорость подключения</dt>
                            <dd class="tariff-description speed">50 Мбит/сек</dd>
                ...
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Телеком Максимум</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Скорость подключения</dt>
                            <dd class="tariff-description speed">100 Мбит/сек</dd>
                        ...
                        <div class="price-container">
                            <dt class="visually-hidden">Стоимость в рублях</dt>
                            <dd class="tariff-description price">1000 в месяц</dd>
                        </div>
                    </dl>
                        <div class="tariff-button-container">
                            <button class="button tariff-button">Подключиться</button></div>
        ...
        <section class="tariffs-screen">
            <h4 class="tariffs-screen-title">Для частных домов</h4>
            <ul class="tariffs-screen-list">
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Телеком Коттедж</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Скорость подключения</dt>
                            <dd class="tariff-description speed">100 Мбит/сек</dd>
                            ...
                            <dt class="visually-hidden">Технология подключения</dt>
                            <dd class="tariff-description technology">xPON (GPON)</dd>
                        <dt class="visually-hidden">Объём данных</dt>
                        <dd class="tariff-description volume-unlimited">безлимитный трафик</dd>
                        </div>
                        <div class="price-container">
                ...
                <li class="tariff-screen-item">
                    <div class="hit">ХИТ</div>
                    <h5 class="tariff-title">Телеком Усадьба</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Скорость подключения</dt>
                            <dd class="tariff-description speed">200 Мбит/сек</dd>
                ...
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Телеком Особняк</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Скорость подключения</dt>
                            <dd class="tariff-description speed">500 Мбит/сек</dd>
        ...
        <section class="tariffs-screen">
            <h4 class="tariffs-screen-title">Прочие услуги</h4>
            <ul class="tariffs-screen-list">
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Подключение интернета</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                        ...
                        <div class="price-container">
                            <dt class="visually-hidden">Стоимость в рублях</dt>
                            <dd class="tariff-description price">10 000</dd>
                        </div>  
                    </dl>
                        <div class="tariff-button-container">
                            <button class="button tariff-button">Выбрать</button>
                        </div>
                            
                      
                </li>
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Устранение неисправности</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Услуга</dt>
                            <dd class="tariff-description master-icon">Вызов мастера</dd>
                        ...
                        <div class="tariff-button-container">
                            <button class="button tariff-button">Выбрать</button></div>
                            </div>
                      
                </li>
                <li class="tariff-screen-item">
                    <h5 class="tariff-title">Турбо кнопка</h5>
                    <dl class="tariff-composition">
                        <div class="tariff-composition-description">
                            <dt class="visually-hidden">Скорость подключения</dt>
                            <dd class="tariff-description speed">1 Гбит/сек</dd>
                       
                            <dt class="visually-hidden">Информация</dt>
                            <dd class="tariff-description info-icon-3">При наличии технической возможности</dd>
                        </div>
                        <div class="price-container">
                            <dt class="visually-hidden">Стоимость в рублях</dt>
        ...
        <section class="reviews">
            ...
            <div class="review-container">
                ...
                <div class="review-text-container">
                    <p class="review-text">
                        <span class="quote"><<</span>  Постоянно пользуюсь услугами компании “Телеком” дома и на работе. Эти ребята помогают всегда мне быть на связи с семьёй и коллегами.
        ...
        <li class="reviews-item review-item-2">
            <div class="review-container">
                ...
                <div class="review-text-container">
                    <p class="review-text">
                        <span class="quote"><<</span>  Спасибо моим партнёрам из “Телекома” за предоставление качественного интернета. Постоянно слежу за фото разбитых дорог Ростова.
        ...
        <li class="reviews-item review-item-3">
            <div class="review-container">
                ...
                <div class="review-text-container">
                    <p class="review-text">
                        <span class="quote"><<</span> Пользуясь случаем, хочу сказать что я использую интернет “Телекома”, его качество такое же хорошее как и наш конфесси..ональный край!
        ...
        <li class="reviews-item review-item-4">
            <div class="review-container">
                ...
                <div class="review-text-container">
                    <p class="review-text">
                        <span class="quote"><<</span>  Мне посоветовали провести интернет “Телекома” в дворце под Геленджиком. Не соврали, отличный интернет, всё летает.
        ...
        <p class="footer-text">вс: выходной</p>
            ...
            <ul class="footer-list">
                <li class="footer-item">
                    <a class="footer-link" href="#">Интернет</a>
                </li>
                <li class="footer-item">
